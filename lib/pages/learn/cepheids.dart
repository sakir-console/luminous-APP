...
class Cepheids extends StatefulWidget {
  @override
  _CepheidsState createState() => _CepheidsState();
}

class _CepheidsState extends State<Cepheids> {
      ...
      body:  IndexedStack(
        ...
        children: [
          ...
          WebView(
            ...
            initialUrl: "https://viewspace.org/interactives/unveiling_invisible_universe/variable_stars/eta_carinae",
